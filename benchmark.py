...
def generate_plots(df):
    ...
    plt.figure(figsize=(14, 10))
    sns.barplot(x="level", y="states_generated", hue="algorithm", data=df)
    ...
    plt.figure(figsize=(14, 10))
    sns.barplot(x="level", y="difference_from_optimal", hue="algorithm", data=df)
    ...
    plt.figure(figsize=(14, 10))
    df["states_per_second"] = df["states_generated"] / df["time"]
